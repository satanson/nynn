    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->basedir);
          this->__isset.basedir = true;
        } else {
...
uint32_t Provider_createSubgraph_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("basedir", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->basedir);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->blk.resize(_size22);
            uint32_t _i26;
            for (_i26 = 0; _i26 < _size22; ++_i26)
            {
              xfer += iprot->readByte(this->blk[_i26]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.blk = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Provider_insertPrev_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("blk", ::apache::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_BYTE, static_cast<uint32_t>(this->blk.size()));
    std::vector<int8_t> ::const_iterator _iter27;
    for (_iter27 = this->blk.begin(); _iter27 != this->blk.end(); ++_iter27)
    {
...
uint32_t Provider_insertPrev_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("blk", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter28 = (*(this->blk)).begin(); _iter28 != (*(this->blk)).end(); ++_iter28)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->blk.resize(_size29);
            uint32_t _i33;
            for (_i33 = 0; _i33 < _size29; ++_i33)
            {
              xfer += iprot->readByte(this->blk[_i33]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.blk = true;
...
uint32_t Provider_insertNext_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("blk", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter34 = this->blk.begin(); _iter34 != this->blk.end(); ++_iter34)
    {
...
uint32_t Provider_insertNext_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("blk", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter35 = (*(this->blk)).begin(); _iter35 != (*(this->blk)).end(); ++_iter35)
    {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->newHeadBlk.clear();
            uint32_t _size36;
            ::apache::thrift::protocol::TType _etype39;
            xfer += iprot->readListBegin(_etype39, _size36);
            this->newHeadBlk.resize(_size36);
            uint32_t _i40;
            for (_i40 = 0; _i40 < _size36; ++_i40)
            {
              xfer += iprot->readByte(this->newHeadBlk[_i40]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.newHeadBlk = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Provider_unshift_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("newHeadBlk", ::apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_BYTE, static_cast<uint32_t>(this->newHeadBlk.size()));
    std::vector<int8_t> ::const_iterator _iter41;
    for (_iter41 = this->newHeadBlk.begin(); _iter41 != this->newHeadBlk.end(); ++_iter41)
    {
...
uint32_t Provider_unshift_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("newHeadBlk", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter42 = (*(this->newHeadBlk)).begin(); _iter42 != (*(this->newHeadBlk)).end(); ++_iter42)
    {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->newTailBlk.clear();
            uint32_t _size43;
            ::apache::thrift::protocol::TType _etype46;
            xfer += iprot->readListBegin(_etype46, _size43);
            this->newTailBlk.resize(_size43);
            uint32_t _i47;
            for (_i47 = 0; _i47 < _size43; ++_i47)
            {
              xfer += iprot->readByte(this->newTailBlk[_i47]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.newTailBlk = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Provider_push_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("newTailBlk", ::apache::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_BYTE, static_cast<uint32_t>(this->newTailBlk.size()));
    std::vector<int8_t> ::const_iterator _iter48;
    for (_iter48 = this->newTailBlk.begin(); _iter48 != this->newTailBlk.end(); ++_iter48)
    {
...
uint32_t Provider_push_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("newTailBlk", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter49 = (*(this->newTailBlk)).begin(); _iter49 != (*(this->newTailBlk)).end(); ++_iter49)
    {
...
int32_t ProviderClient::createSubgraph(const std::string& basedir)
{
  send_createSubgraph(basedir);
  return recv_createSubgraph();
}

void ProviderClient::send_createSubgraph(const std::string& basedir)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::recv_createSubgraph()
{
...
int32_t ProviderClient::destroySubgraph(const std::string& basedir)
{
  send_destroySubgraph(basedir);
  return recv_destroySubgraph();
}

void ProviderClient::send_destroySubgraph(const std::string& basedir)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::recv_destroySubgraph()
{
...
int32_t ProviderClient::attachSubgraph(const std::string& basedir)
{
  send_attachSubgraph(basedir);
  return recv_attachSubgraph();
}

void ProviderClient::send_attachSubgraph(const std::string& basedir)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::recv_attachSubgraph()
{
...
int32_t ProviderClient::detachSubgraph(const std::string& basedir)
{
  send_detachSubgraph(basedir);
  return recv_detachSubgraph();
}

void ProviderClient::send_detachSubgraph(const std::string& basedir)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::recv_detachSubgraph()
{
...
int32_t ProviderClient::lock(const int32_t vtxno, const int32_t flag)
{
...
int32_t ProviderClient::recv_lock()
{
...
int32_t ProviderClient::unlock(const int32_t vtxno)
{
  send_unlock(vtxno);
  return recv_unlock();
}
...
int32_t ProviderClient::recv_unlock()
{
...
int32_t ProviderClient::insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk)
{
  send_insertPrev(vtxno, nextBlkno, blk);
  return recv_insertPrev();
}

void ProviderClient::send_insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk)
{
  send_insertNext(vtxno, prevBlkno, blk);
  return recv_insertNext();
}

void ProviderClient::send_insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk)
{
  send_unshift(vtxno, newHeadBlk);
  return recv_unshift();
}

void ProviderClient::send_unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk)
{
  int32_t cseqid = 0;
...
int32_t ProviderClient::push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk)
{
  send_push(vtxno, newTailBlk);
  return recv_push();
}

void ProviderClient::send_push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk)
{
  int32_t cseqid = 0;
...
void ProviderProcessor::process_createSubgraph(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->createSubgraph(args.basedir);
...
void ProviderProcessor::process_destroySubgraph(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->destroySubgraph(args.basedir);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_attachSubgraph(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->attachSubgraph(args.basedir);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_detachSubgraph(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->detachSubgraph(args.basedir);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_insertPrev(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->insertPrev(args.vtxno, args.nextBlkno, args.blk);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_insertNext(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->insertNext(args.vtxno, args.prevBlkno, args.blk);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_unshift(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->unshift(args.vtxno, args.newHeadBlk);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void ProviderProcessor::process_push(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->push(args.vtxno, args.newTailBlk);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
