...
class ProviderIf {
 public:
  virtual ~ProviderIf() {}
  virtual int32_t createSubgraph(const std::string& basedir) = 0;
  virtual int32_t destroySubgraph(const std::string& basedir) = 0;
  virtual int32_t attachSubgraph(const std::string& basedir) = 0;
  virtual int32_t detachSubgraph(const std::string& basedir) = 0;
  virtual void getSubgraphKeys(std::vector<int32_t> & _return) = 0;
  virtual int32_t lock(const int32_t vtxno, const int32_t flag) = 0;
  virtual int32_t unlock(const int32_t vtxno) = 0;
  ...
  virtual int32_t insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk) = 0;
  virtual int32_t insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk) = 0;
  virtual int32_t remove(const int32_t vtxno, const int32_t blkno) = 0;
  virtual int32_t unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk) = 0;
  virtual int32_t shift(const int32_t vtxno) = 0;
  virtual int32_t push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk) = 0;
...
class ProviderNull : virtual public ProviderIf {
 public:
  ...
  int32_t createSubgraph(const std::string& /* basedir */) {
    int32_t _return = 0;
    return _return;
  }
  int32_t destroySubgraph(const std::string& /* basedir */) {
    int32_t _return = 0;
    return _return;
  }
  int32_t attachSubgraph(const std::string& /* basedir */) {
    int32_t _return = 0;
    return _return;
  }
  int32_t detachSubgraph(const std::string& /* basedir */) {
    int32_t _return = 0;
    return _return;
  }
  ...
  int32_t lock(const int32_t /* vtxno */, const int32_t /* flag */) {
    int32_t _return = 0;
    return _return;
  }
  int32_t unlock(const int32_t /* vtxno */) {
    int32_t _return = 0;
    return _return;
  }
...
typedef struct _Provider_createSubgraph_args__isset {
  _Provider_createSubgraph_args__isset() : basedir(false) {}
  bool basedir;
...
class Provider_createSubgraph_args {
 public:
  ...
  Provider_createSubgraph_args() : basedir() {
  }
  ...
  void __set_basedir(const std::string& val) {
    basedir = val;
  }

  bool operator == (const Provider_createSubgraph_args & rhs) const
  {
    if (!(basedir == rhs.basedir))
      return false;
    return true;
  }
  bool operator != (const Provider_createSubgraph_args &rhs) const {
...
typedef struct _Provider_destroySubgraph_args__isset {
  _Provider_destroySubgraph_args__isset() : basedir(false) {}
  bool basedir;
...
class Provider_destroySubgraph_args {
 public:
  ...
  Provider_destroySubgraph_args() : basedir() {
  }
...
typedef struct _Provider_attachSubgraph_args__isset {
  _Provider_attachSubgraph_args__isset() : basedir(false) {}
  bool basedir;
...
class Provider_attachSubgraph_args {
 public:
  ...
  Provider_attachSubgraph_args() : basedir() {
  }
...
typedef struct _Provider_detachSubgraph_args__isset {
  _Provider_detachSubgraph_args__isset() : basedir(false) {}
  bool basedir;
...
class Provider_detachSubgraph_args {
 public:
  ...
  Provider_detachSubgraph_args() : basedir() {
  }
...
typedef struct _Provider_insertPrev_args__isset {
  _Provider_insertPrev_args__isset() : vtxno(false), nextBlkno(false), blk(false) {}
  bool vtxno;
  bool nextBlkno;
  bool blk;
...
class Provider_insertPrev_args {
 public:
  ...
  void __set_blk(const std::vector<int8_t> & val) {
    blk = val;
  }
...
typedef struct _Provider_insertNext_args__isset {
  _Provider_insertNext_args__isset() : vtxno(false), prevBlkno(false), blk(false) {}
  bool vtxno;
  bool prevBlkno;
  bool blk;
...
typedef struct _Provider_unshift_args__isset {
  _Provider_unshift_args__isset() : vtxno(false), newHeadBlk(false) {}
  bool vtxno;
  bool newHeadBlk;
...
class Provider_unshift_args {
 public:
  ...
  void __set_newHeadBlk(const std::vector<int8_t> & val) {
    newHeadBlk = val;
  }
...
class Provider_unshift_pargs {
 public:
  ...
  const int32_t* vtxno;
  const std::vector<int8_t> * newHeadBlk;
...
typedef struct _Provider_push_args__isset {
  _Provider_push_args__isset() : vtxno(false), newTailBlk(false) {}
  bool vtxno;
  bool newTailBlk;
...
class Provider_push_args {
 public:
  ...
  void __set_newTailBlk(const std::vector<int8_t> & val) {
    newTailBlk = val;
  }
...
class Provider_push_pargs {
 public:
  ...
  const int32_t* vtxno;
  const std::vector<int8_t> * newTailBlk;
...
class ProviderClient : virtual public ProviderIf {
 public:
  ...
  int32_t createSubgraph(const std::string& basedir);
  void send_createSubgraph(const std::string& basedir);
  int32_t recv_createSubgraph();
  int32_t destroySubgraph(const std::string& basedir);
  void send_destroySubgraph(const std::string& basedir);
  int32_t recv_destroySubgraph();
  int32_t attachSubgraph(const std::string& basedir);
  void send_attachSubgraph(const std::string& basedir);
  int32_t recv_attachSubgraph();
  int32_t detachSubgraph(const std::string& basedir);
  void send_detachSubgraph(const std::string& basedir);
  int32_t recv_detachSubgraph();
  void getSubgraphKeys(std::vector<int32_t> & _return);
  ...
  int32_t insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk);
  void send_insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk);
  int32_t recv_insertPrev();
  int32_t insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk);
  void send_insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk);
  int32_t recv_insertNext();
  int32_t remove(const int32_t vtxno, const int32_t blkno);
  void send_remove(const int32_t vtxno, const int32_t blkno);
  int32_t recv_remove();
  int32_t unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk);
  void send_unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk);
  int32_t recv_unshift();
  int32_t shift(const int32_t vtxno);
  void send_shift(const int32_t vtxno);
  int32_t recv_shift();
  int32_t push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk);
  void send_push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk);
  int32_t recv_push();
  int32_t pop(const int32_t vtxno);
...
class ProviderMultiface : virtual public ProviderIf {
 ...
 public:
  int32_t createSubgraph(const std::string& basedir) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->createSubgraph(basedir);
    }
    return ifaces_[i]->createSubgraph(basedir);
  }
  ...
  int32_t destroySubgraph(const std::string& basedir) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->destroySubgraph(basedir);
    }
    return ifaces_[i]->destroySubgraph(basedir);
  }
  ...
  int32_t attachSubgraph(const std::string& basedir) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->attachSubgraph(basedir);
    }
    return ifaces_[i]->attachSubgraph(basedir);
  }
  ...
  int32_t detachSubgraph(const std::string& basedir) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->detachSubgraph(basedir);
    }
    return ifaces_[i]->detachSubgraph(basedir);
  }
  ...
  int32_t insertPrev(const int32_t vtxno, const int32_t nextBlkno, const std::vector<int8_t> & blk) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->insertPrev(vtxno, nextBlkno, blk);
    }
    return ifaces_[i]->insertPrev(vtxno, nextBlkno, blk);
  }
  ...
  int32_t insertNext(const int32_t vtxno, const int32_t prevBlkno, const std::vector<int8_t> & blk) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->insertNext(vtxno, prevBlkno, blk);
    }
    return ifaces_[i]->insertNext(vtxno, prevBlkno, blk);
  }
  ...
  int32_t unshift(const int32_t vtxno, const std::vector<int8_t> & newHeadBlk) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->unshift(vtxno, newHeadBlk);
    }
    return ifaces_[i]->unshift(vtxno, newHeadBlk);
  }
  ...
  int32_t push(const int32_t vtxno, const std::vector<int8_t> & newTailBlk) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->push(vtxno, newTailBlk);
    }
    return ifaces_[i]->push(vtxno, newTailBlk);
  }
