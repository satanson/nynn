        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->edge.resize(_size18);
            uint32_t _i22;
            for (_i22 = 0; _i22 < _size18; ++_i22)
            {
              xfer += this->edge[_i22].read(iprot);
            }
...
uint32_t DataXMaster_update_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("edge", ::apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->edge.size()));
    std::vector<xedge_t> ::const_iterator _iter23;
    for (_iter23 = this->edge.begin(); _iter23 != this->edge.end(); ++_iter23)
    {
...
uint32_t DataXMaster_update_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->edge)).size()));
    std::vector<xedge_t> ::const_iterator _iter24;
    for (_iter24 = (*(this->edge)).begin(); _iter24 != (*(this->edge)).end(); ++_iter24)
    {
...
bool DataXMasterClient::update(const std::vector<xedge_t> & edge)
{
  send_update(edge);
  return recv_update();
}

void DataXMasterClient::send_update(const std::vector<xedge_t> & edge)
{
  int32_t cseqid = 0;
...
void DataXMasterProcessor::process_update(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->update(args.edge);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
