...
int main(int argc,char*argv[])
{
	...
	while(true){
		...
		if(ch=='?'){
			cout<<"nynn_read:invalid option -- '"
				<<(char)optopt<<"'"<<endl;
			cout<<"Usage:nynn_read [-s num] [-H host] [-i msgid] [-I msgid]"<<endl;
			cout<<"Try \"nynn_read -h for more help\""<<endl;
			exit(0);
		}else if (ch==':'){
			cout<<"nynn_read:option requires argument -- '"
				<<(char)optopt<<"'"<<endl;
			cout<<"Usage:nynn_read [-s num] [-H host] [-i msgid] [-I msgid]"<<endl;
			cout<<"Try \"nynn_read -h for more help\""<<endl;
			exit(0);
			...
			cout<<"Usage:nynn_read [-s num] [-H host] [-i msgid] [-I msgid]"<<endl;
			cout<<"nynn_read is a client for writing message."<<endl;
			cout<<"Options:"<<endl;
